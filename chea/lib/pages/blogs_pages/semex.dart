...
class SemExBlog extends StatefulWidget {
  @override
  _SemExBlogState createState() => _SemExBlogState();
}

class _SemExBlogState extends State<SemExBlog> with SingleTickerProviderStateMixin {
  List<Blog> blogs = [];
  bool isLoading = true;
  ...
  Future<void> fetchBlogs() async {
    try {
      ...
      List<Blog> fetchedBlogs = await blogService.fetchBlogsByType('SemEx');
