...
class ICYDontKnowBlog extends StatefulWidget {
  @override
  _ICYDontKnowBlogState createState() => _ICYDontKnowBlogState();
}

class _ICYDontKnowBlogState extends State<ICYDontKnowBlog> with SingleTickerProviderStateMixin {
  List<Blog> blogs = [];
  bool isLoading = true;
  ...
  Future<void> fetchBlogs() async {
    try {
      ...
      List<Blog> fetchedBlogs = await blogService.fetchBlogsByType('ICYDontKnow');
