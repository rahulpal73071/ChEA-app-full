...
class _InternBlogState extends State<InternBlog> with SingleTickerProviderStateMixin {
  List<Blog> blogs = [];
  bool isLoading = true;
  ...
  Future<void> fetchBlogs() async {
    try {
      ...
      List<Blog> fetchedBlogs = await blogService.fetchBlogsByType('Internship');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // ⬇️ Stack for floating action buttons
      body: Stack(
        children: [
          // Main content
          Column(
          ...
          // Positioned Add FAB above profile icon
          Positioned(
            bottom: 80,
            right: 16,
