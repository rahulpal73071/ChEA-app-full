...
class ThenVsNowBlog extends StatefulWidget {
  @override
  _ThenVsNowBlogState createState() => _ThenVsNowBlogState();
}

class _ThenVsNowBlogState extends State<ThenVsNowBlog> with SingleTickerProviderStateMixin {
  List<Blog> blogs = [];
  bool isLoading = true;
  ...
  Future<void> fetchBlogs() async {
    try {
      ...
      List<Blog> fetchedBlogs = await blogService.fetchBlogsByType('ThenVsNow');
