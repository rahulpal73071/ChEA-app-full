...
class InternEraBlog extends StatefulWidget {
  @override
  _InternEraBlogState createState() => _InternEraBlogState();
}

class _InternEraBlogState extends State<InternEraBlog> with SingleTickerProviderStateMixin {
  List<Blog> blogs = [];
  bool isLoading = true;
  ...
  Future<void> fetchBlogs() async {
    try {
      ...
      List<Blog> fetchedBlogs = await blogService.fetchBlogsByType('InternEra');
